...
function ConversorDeMoedas() {
  ...
  useEffect(() => {
    fetch('https://api.exchangeratesapi.io/v1/latest?access_key=142e65253ce849d3eafd32cfe7561907&format=1')
  ...
  const converterMoeda = () => {
    fetch(`https://api.exchangeratesapi.io/v1/latest?access_key=142e65253ce849d3eafd32cfe7561907&format=1base=
${deMoeda}&symbols=${paraMoeda}`)
      .then(response => response.json())
      .then(data => {
